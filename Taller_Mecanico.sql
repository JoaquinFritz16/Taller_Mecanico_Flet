...
CREATE TABLE detalle_ficha (
    ...
    KEY FK_cod_repuesto (cod_repuesto),
    CONSTRAINT FK_nro_ficha FOREIGN KEY (nro_ficha)
        REFERENCES ficha_tecnica (nro_ficha) ON UPDATE CASCADE,
    CONSTRAINT FK_cod_repuesto FOREIGN KEY (cod_repuesto)
        REFERENCES repuestos (cod_repuesto) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
USE taller_mecanico;
SHOW TABLES LIKE 'ficha_tecnica';
INSERT INTO repuestos (cod_repuesto, descripcion, pcio_unit) VALUES
('R001', 'Filtro de aceite', 1500),
('R002', 'Pastilla de freno', 3500),
('R003', 'Bujía', 800);
